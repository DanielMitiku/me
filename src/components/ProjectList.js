...
import book_a_session_frontend from '../images/book_a_session.png';
import book_a_session_backend from '../images/book_a_session_backend.png';
import rails_book from '../images/rails_book.png';
  ...
  const list = {
    projects: [
      ...
      },
      {
        ...
        image: weather_app,
        header: 'Fetch real-time weather info using APIs',
      ...
      },
      {
        ...
        image: battleship,
        header: 'Classic Battleship game against a computer',
